# Chimp Exchange Frontend App (v2)

Official frontend app for the Chimp Exchange protocol (v2)
...
As we believe in decentralization at all layers, we've made it easy to host your own Chimp Exchange Frontend.

### Docker Production Image

We've created a production ready [docker image](./Dockerfile) runs
a pre-built version of Chimp Exchange Frontend-v2 using nginx. You'll need your own
