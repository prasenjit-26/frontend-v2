...
import { Pool as SDKPool, PoolToken } from '@auroblocks/chimp-sdk';

export type { SubPool, PoolToken } from '@auroblocks/chimp-sdk';
export { PoolType } from '@auroblocks/chimp-sdk';
